...
happyExpList = Happy_Data_Array.listArray (0,27) ([1408,32,16384,0,2816,0,32768,5,1,0,32,11,0,0
	])

{-# NOINLINE happyExpListPerState #-}
happyExpListPerState st =
    token_strs_expected
  where token_strs = ["error","%dummy","%start_parseExpr","Expr","App","Lamb","Term","IDENT","LAMBDA","DOT","LEFTP","RIGHTP","%eof"]
        bit_start = st * 13
        bit_end = (st + 1) * 13
...
action_13 (6) = happyGoto action_2
